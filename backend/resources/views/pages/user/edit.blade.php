  ...
  <section class="content">
    <div class="row">
        <div class="col-12" id="validasi">
            <form class="row d-flex flex-wrap flex-column align-items-center" method="post" action="{{ route('user.update', ['id' => $user->id]) }}">
                @csrf
                @if($errors->any())
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" value="{{ $user->name }}" name="name" required autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" value="{{ $user->email }}" disabled autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="password" class="form-control"  name="password" autocomplete="off" placeholder="Kosongkan jika tidak ingin mengganti password">
                                </div>
                            </div>
